-- ========== 1: ENUM ========== --
-- Creation de nouveaux types pour eviter des contraintes CHECK trop longues
CREATE TYPE brin AS ENUM ('+', '-');

CREATE TYPE te_classe_type AS ENUM ('I', 'II');
...
CREATE TYPE troncature_type AS ENUM (
    ...
    'soloLTR' -- modif: verifier que si soloLTR, type est LTR
);

CREATE TYPE relation_gene_type AS ENUM (
    'amont',        
    'aval',         
    'chevauchant'   -- a l'interieur du gene
);
...
CREATE TABLE Annotation (
    ...
    TypeTroncature troncature_type NOT NULL,
